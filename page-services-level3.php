  ...
  <div class="content-position">
    <div class="content-column">
      ...
      <div class="order-service">
        ...
        <a class="btn-order" href="<?php pll_e('order_link_lang'); ?>"><span
            class="decor"><?php pll_e('Получить консультацию'); ?></span></a>

        <div class="hr"></div>
      </div>
      <?php if (have_rows('dop_mats')): ?>
        <div class="relevant-links">
          <div style="padding: 0 0 16px;font: 16px 'Ubuntu', Arial; color: #000;">
            <?php pll_e('Другие материалы по теме'); ?></div>
          <ul class="links-list">
            <?php while (have_rows('dop_mats')):
              the_row();
      ...
      <?php else:
        $childrens_services = get_children(
          array(
