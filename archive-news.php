            ...
            <?php if ($news_posts->have_posts()) : while ($news_posts->have_posts()) : $news_posts->the_post(); ?>
                ...
                <li>
                    <?php if(get_the_date('d.m.Y') == $today):
                        ?><span class="date"><?php pll_e('today');?></span><?php
                    else:
                        ?><span class="date"><?php echo get_the_date('d.m.Y');?></span><?php
                    endif;?>
...
?>
<script>
jQuery('#menu-item-12032').addClass('current_page_item');
jQuery('#menu-item-12031').addClass('current_page_item');
