...
<!--                 <span class="title">
    ...
    <div class="right-column">
      <div class="news-sidebar">
        <div class="news-sidebar__title" style="padding: 0; font-weight: 500; position: relative; font: 18px 'Ubuntu', Arial;color: #000;">
          <?php pll_e('social2');
			$news_link = pll__('news_link');	
			if (function_exists('get_effective_language') && get_effective_language() === 'en') {
					$news_link = home_url('/en' . parse_url($news_link, PHP_URL_PATH));
			}			?>
          <a style="position: absolute;top: 9px;right: -2px;color: #959595;font: 12px 'arial';"
            href="<?php echo esc_url($news_link); ?>"><?php pll_e('read_all'); ?></a>
        </div>
        <ul>
          <?php if ($news_posts->have_posts()):
            while ($news_posts->have_posts()):
              ...
              <?php $url = get_permalink();
				if (function_exists('get_effective_language') && get_effective_language() === 'en') {
					$url = home_url('/en' . parse_url($url, PHP_URL_PATH));
				}?>
              <li>
  ...
  <div class="index-nav">
    <ul>
      <?php
      if (have_rows('h_services_link')):
        while (have_rows('h_services_link')):
          the_row();
  ...
  <div class="index-banners">
    <ul>
      <?php
      if (have_rows('h_b_pages')):
        while (have_rows('h_b_pages')):
          the_row();
          ...
          ?>
          <li>
          <a href="<?php echo get_page_link($page->ID); ?>"> <!-- <?php pll_e('uzb2'); ?> -->
