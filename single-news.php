      ...
      <div class="breadcrumbs" id="breadcrumbs">
        <span xmlns:v="//rdf.data-vocabulary.org/#">
          <span typeof="v:Breadcrumb">
            <a href="<?php pll_e('breadcrumbs-home'); ?>" rel="v:url"
              property="v:title"><?php pll_e('breadcrumbs-home1222'); ?></a>
            → <a href="<?php pll_e('breadcrumbs-news'); ?>" rel="v:url"
              property="v:title"><?php pll_e('social2'); ?></a>
...
?>
<script>
jQuery('#menu-item-12796').addClass('current_page_item');
jQuery('#menu-item-12797').addClass('current_page_item');
